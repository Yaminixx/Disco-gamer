...
namespace osu.Game.Rulesets.Disco.Objects.Drawables
{
    public partial class DrawableDiscoHitObject : DrawableHitObject<DiscoHitObject>
    {
        ...
        public DrawableDiscoHitObject(DiscoHitObject hitObject)
            : base(hitObject)
        {
            Size = new Vector2(80);
